...
public class UserController {
    ...
    public ResponseEntity<User> register(@RequestParam String email, @RequestParam String nickname, @RequestParam String password, @RequestParam String profileImage) {
    ...
    // 회원정보 수정
    @PutMapping("/{id}")
    public ResponseEntity<User> updatedUser(@PathVariable Long id, @RequestParam String nickname, @RequestParam String profileImage) {
